...
public class BoundingBoxManager {
    ...
    static {
        ...
        registerHeadshotBox(ModEntities.SENPAI, new BasicHeadshotBox<>(8.0, 22.0));
        registerHeadshotBox(ModEntities.TARGET, new BasicHeadshotBox<>(14.0, 20.0));
    ...
    public static void onPlayerTick(Player player) {
        ...
        LinkedList<AABB> boxes = playerBoxes.computeIfAbsent(player, player1 -> new LinkedList<>());
