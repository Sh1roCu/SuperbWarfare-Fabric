...
public class Bmp2Entity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {
        ...
        return new VehicleWeapon[][]{
                new VehicleWeapon[]{
                        new SmallCannonShellWeapon()
                                ...
                                .sound1p(ModSounds.BMP_CANNON_FIRE_1P)
                                .sound3p(ModSounds.BMP_CANNON_FIRE_3P)
                                .sound3pFar(ModSounds.LAV_CANNON_FAR)
                                .sound3pVeryFar(ModSounds.LAV_CANNON_VERYFAR),
                        new ProjectileWeapon()
                                ...
                                .sound1p(ModSounds.COAX_FIRE_1P)
                                .sound3p(ModSounds.M_60_FIRE_3P)
                                .sound3pFar(ModSounds.M_60_FAR)
                                .sound3pVeryFar(ModSounds.M_60_VERYFAR),
                        new WgMissileWeapon()
                                ...
                                .sound(ModSounds.INTO_MISSILE)
                                .sound1p(ModSounds.BMP_MISSILE_FIRE_1P)
                                .sound3p(ModSounds.BMP_MISSILE_FIRE_3P),
                },
                new VehicleWeapon[]{
                        // 成员机枪
                        new ProjectileWeapon()
                                ...
                                .icon(Mod.loc("textures/screens/vehicle_weapon/gun_7_62mm.png"))
                                .sound1p(ModSounds.COAX_FIRE_1P)
                                .sound3p(ModSounds.AK_47_FIRE_3P)
                                .sound3pFar(ModSounds.AK_47_FAR)
                                .sound3pVeryFar(ModSounds.AK_47_VERYFAR),
                },
                new VehicleWeapon[]{
                        // 成员机枪
                        new ProjectileWeapon()
    ...
    private void handleAmmo() {
        ...
        int mgAmmoCount = this.getItemStacks().stream().filter(stack -> {
            ...
            return false;
        }).mapToInt(Ammo.RIFLE::get).sum() + countItem(ModItems.RIFLE_AMMO);

        if ((hasItem(ModItems.WIRE_GUIDE_MISSILE) || hasCreativeAmmo)
            ...
            if (!hasCreativeAmmo) {
                this.getItemStacks().stream().filter(stack -> stack.is(ModItems.WIRE_GUIDE_MISSILE)).findFirst().ifPresent(stack -> stack.shrink(1));
            }
            this.level().playSound(null, this, ModSounds.BMP_MISSILE_RELOAD, this.getSoundSource(), 1, 1);
        }

        if (getWeaponIndex(0) == 0) {
            this.entityData.set(AMMO, countItem(ModItems.SMALL_SHELL));
        ...
        this.entityData.set(MISSILE_COUNT, countItem(ModItems.WIRE_GUIDE_MISSILE));
    }
                ...
                if (this.entityData.get(MG_AMMO) > 0 || hasCreativeAmmo) {
                    ...
                    if (!hasCreativeAmmo) {
                        ...
                        if (!ammoBox.isEmpty()) {
                            ...
                            this.getItemStacks().stream().filter(stack -> stack.is(ModItems.RIFLE_AMMO)).findFirst().ifPresent(stack -> stack.shrink(1));
                        }
                    }
                }
                ...
                if (this.entityData.get(MG_AMMO) > 0 || hasCreativeAmmo) {
                    ...
                    if (living instanceof Mob mob && mob.getTarget() != null) {
                        ...
                        if (target instanceof LivingEntity pLiving) {
                            double gravity = pLiving.getAttributeValue(PortingLibAttributes.ENTITY_GRAVITY);
