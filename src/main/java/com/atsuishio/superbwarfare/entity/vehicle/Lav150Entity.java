...
public class Lav150Entity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, WeaponVehicleEntity, OBBEntity {
        ...
        return new VehicleWeapon[][]{
                new VehicleWeapon[]{
                        new SmallCannonShellWeapon()
                                ...
                                .sound1p(ModSounds.LAV_CANNON_FIRE_1P)
                                .sound3p(ModSounds.LAV_CANNON_FIRE_3P)
                        ...
                        new ProjectileWeapon()
                                ...
                                .sound3p(ModSounds.RPK_FIRE_3P)
                                .sound3pFar(ModSounds.RPK_FAR)
                                .sound3pVeryFar(ModSounds.RPK_VERYFAR),
                }
        };
    }
    ...
    protected void playStepSound(BlockPos pPos, BlockState pState) {
        this.playSound(ModSounds.WHEEL_STEP, (float) (getDeltaMovement().length() * 0.3), random.nextFloat() * 0.15f + 1.05f);
    }
