...
public class GameRendererMixin {
    ...
    private double sw$viewportFovEvent(double original, @Local(argsOnly = true) Camera camera, @Local(argsOnly = true) float partialTicks, @Local(argsOnly = true) boolean useConfigured) {
