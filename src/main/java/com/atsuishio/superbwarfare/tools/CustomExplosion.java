...
public class CustomExplosion extends Explosion {
    ...
    public void explode() {
        ...
        ExplosionEvents.DETONATE.invoker().onDetonate(this.level, this, list, diameter);
    ...
    public static class Builder {
        ...
        private Supplier<BlockInteraction> destroyBlock = () -> ExplosionConfig.EXPLOSION_DESTROY.get() ? BlockInteraction.DESTROY : BlockInteraction.KEEP;
        ...
        public Builder keepBlock() {
            this.destroyBlock = () -> BlockInteraction.KEEP;
            return this;
        }
        ...
        public void explode() {
            ...
            ExplosionEvents.START.invoker().onExplosionStart(directSource.level(), customExplosion);
