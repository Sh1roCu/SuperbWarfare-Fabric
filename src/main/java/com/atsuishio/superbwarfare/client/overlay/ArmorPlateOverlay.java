...
public class ArmorPlateOverlay {
    ...
    public static void render(GuiGraphics guiGraphics, float partialTick) {
        ...
        // 渲染图标
        guiGraphics.blit(ICON, 10, guiGraphics.guiHeight() - 13, 0, 0, 8, 8, 8, 8);

        // 渲染框架
        guiGraphics.blit(frame, 20, guiGraphics.guiHeight() - 12, 0, 0, 60, 6, 60, 6);

        // 渲染盔甲值
        guiGraphics.blit(texture, 20, guiGraphics.guiHeight() - 12, 0, 0, (int) amount, 6, 60, 6);
