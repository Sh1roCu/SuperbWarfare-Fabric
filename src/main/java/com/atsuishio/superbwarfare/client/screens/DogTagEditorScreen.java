...
public class DogTagEditorScreen extends Screen {
    ...
    class FinishButton extends AbstractButton {
        ...
        public void onPress() {
            ...
            new DogTagFinishEditMessage(DogTagEditorScreen.this.icon, DogTagEditorScreen.this.name.getValue(),
                    DogTagEditorScreen.this.hand == InteractionHand.MAIN_HAND).send();
        }
