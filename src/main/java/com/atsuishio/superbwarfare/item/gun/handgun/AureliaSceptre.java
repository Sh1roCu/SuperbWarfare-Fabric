...
public class AureliaSceptre extends GunItem implements IRarity {
    ...
    public AureliaSceptre(ChatFormatting color) {
        this();
    ...
    public HumanoidModel.ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack stack) {
        ...
        // TODO
//        final HumanoidModel.ArmPose POSE = HumanoidModel.ArmPose.create("AureliaSceptre", false, (model, entity, arm) -> {
