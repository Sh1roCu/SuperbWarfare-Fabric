...
public class MiscConfig {
    ...
    public static ForgeConfigSpec.LongValue CHARGING_STATION_MAX_ENERGY;
    ...
    public static void init(ForgeConfigSpec.Builder builder) {
        ...
        CHARGING_STATION_MAX_ENERGY = builder.defineInRange("charging_station_max_energy", 4000000, 1, Long.MAX_VALUE);
