...
public class Ah6Entity extends ContainerMobileVehicleEntity implements GeoEntity, HelicopterEntity, WeaponVehicleEntity, OBBEntity {
        ...
        return new VehicleWeapon[][]{
                new VehicleWeapon[]{
                        new SmallCannonShellWeapon()
                                ...
                                .sound1p(ModSounds.HELICOPTER_CANNON_FIRE_1P)
                                .sound3p(ModSounds.HELICOPTER_CANNON_FIRE_3P)
                                .sound3pFar(ModSounds.HELICOPTER_CANNON_FAR)
                                .sound3pVeryFar(ModSounds.HELICOPTER_CANNON_VERYFAR),
                        new SmallRocketWeapon()
                                ...
                                .sound1p(ModSounds.SMALL_ROCKET_FIRE_1P)
                                .sound3p(ModSounds.SMALL_ROCKET_FIRE_3P),
                }
        };
    }
    ...
    public @NotNull InteractionResult interact(Player player, @NotNull InteractionHand hand) {
        ...
        if (stack.getItem() == ModItems.SMALL_ROCKET && this.entityData.get(LOADED_ROCKET) < 14) {
            // 装载火箭
    ...
    private void handleAmmo() {
        ...
        if ((hasItem(ModItems.SMALL_ROCKET) || InventoryTool.hasCreativeAmmoBox(player)) && reloadCoolDown == 0 && this.getEntityData().get(LOADED_ROCKET) < 14) {
        ...
        if (getHealth() > 0.1f * getMaxHealth()) {
            ...
            if (this.level() instanceof ServerLevel) {
                if (this.getEnergy() > 0) {
                    ...
                    if (!engineStart && up) {
                        engineStart = true;
                        this.level().playSound(null, this, ModSounds.HELICOPTER_ENGINE_START, this.getSoundSource(), 3, 1);
                    }
    ...
    public SoundEvent getEngineSound() {
        return ModSounds.HELICOPTER_ENGINE;
    }
