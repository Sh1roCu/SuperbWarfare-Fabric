...
public class Ntw20Item extends GunItem implements IRarity {
    ...
    public Ntw20Item(ChatFormatting color) {
        this();
    ...
    public Set<SoundEvent> getReloadSound() {
        return Set.of(ModSounds.NTW_20_RELOAD_EMPTY, ModSounds.NTW_20_RELOAD_NORMAL, ModSounds.NTW_20_BOLT);
    }
