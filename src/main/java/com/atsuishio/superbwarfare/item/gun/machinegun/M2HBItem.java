...
public class M2HBItem extends GunItem {
    ...
    public Set<SoundEvent> getReloadSound() {
        return Set.of(ModSounds.M_2_HB_RELOAD_EMPTY, ModSounds.M_2_HB_RELOAD_NORMAL);
    }
    ...
    public HumanoidModel.ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack stack) {
        ...
        // TODO
//        final HumanoidModel.ArmPose POSE = HumanoidModel.ArmPose.create("M2HB", false, (model, entity, arm) -> {
