...
public class CannonHudOverlay {
    ...
    public static void render(GuiGraphics guiGraphics, float partialTick) {
        ...
        if (vehicle instanceof CannonEntity cannonEntity && cannonEntity instanceof VehicleEntity cannon) {
            ...
            preciseBlit(guiGraphics, Mod.loc("textures/screens/compass.png"), (float) guiGraphics.guiWidth() / 2 - 128, (float) 10, 128 + ((float) 64 / 45 * (Mth.lerp(partialTick, cannon.yRotO, cannon.getYRot()))), 0, 256, 16, 512, 16);
            preciseBlit(guiGraphics, Mod.loc("textures/screens/roll_ind_white.png"), (float) guiGraphics.guiWidth() / 2 - 4, 27, 0, 0.0F, 8, 8, 8, 8);
            ...
            guiGraphics.drawString(Minecraft.getInstance().font, Component.literal(angle), guiGraphics.guiWidth() / 2 - width / 2, 40, -1, false);

            preciseBlit(guiGraphics, Mod.loc("textures/screens/cannon/cannon_pitch.png"), (float) guiGraphics.guiWidth() / 2 + 166, (float) guiGraphics.guiHeight() / 2 - 64, 0, 0.0F, 8, 128, 8, 128);
            ...
            preciseBlit(guiGraphics, Mod.loc("textures/screens/cannon/cannon_pitch_ind.png"), (float) guiGraphics.guiWidth() / 2 + 158, (float) guiGraphics.guiHeight() / 2 - 4, 0, 0.0F, 8, 8, 8, 8);
            guiGraphics.drawString(Minecraft.getInstance().font, Component.literal(pitch), guiGraphics.guiWidth() / 2 + 157 - widthP, guiGraphics.guiHeight() / 2 - 4, -1, false);
            poseStack.popPose();
                ...
                if (ClientEventHandler.zoomVehicle) {
                    ...
                    if (lookAtEntity) {
                        guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.drone.range")
                                ...
                                guiGraphics.guiWidth() / 2 + 14, guiGraphics.guiHeight() / 2 - 20, -1, false);
                    } else {
                        if (blockRange > 511) {
                            guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.drone.range")
                                    .append(Component.literal("---m")), guiGraphics.guiWidth() / 2 + 14, guiGraphics.guiHeight() / 2 - 20, -1, false);
                        } else {
                            guiGraphics.drawString(Minecraft.getInstance().font, Component.translatable("tips.superbwarfare.drone.range")
                    ...
                    if (!(cannon instanceof Hpj11Entity)) {
                        ...
                        preciseBlit(guiGraphics, Mod.loc("textures/screens/cannon/indicator.png"), (float) guiGraphics.guiWidth() / 2 - 4.3f + 0.45f * diffY, (float) guiGraphics.guiHeight() / 2 - 10, 0, 0.0F, 8, 8, 8, 8);
                    } else {
