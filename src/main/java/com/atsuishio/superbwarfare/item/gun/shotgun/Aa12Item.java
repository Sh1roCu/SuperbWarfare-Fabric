...
public class Aa12Item extends GunItem implements IRarity {
    ...
    public Aa12Item(ChatFormatting color) {
        this();
    ...
    public Set<SoundEvent> getReloadSound() {
        return Set.of(ModSounds.AA_12_RELOAD_EMPTY, ModSounds.AA_12_RELOAD_NORMAL);
    }
