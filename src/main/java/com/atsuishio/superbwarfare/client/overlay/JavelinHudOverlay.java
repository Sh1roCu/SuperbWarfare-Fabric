...
public class JavelinHudOverlay {
    ...
    public static void render(GuiGraphics guiGraphics, float partialTick) {
        ...
        if ((stack.getItem() == ModItems.JAVELIN && ClientEventHandler.zoomPos > 0.8) && Minecraft.getInstance().options.getCameraType().isFirstPerson() && ClientEventHandler.zoom) {
            ...
            float k = ((guiGraphics.guiWidth() - i) / 2) + moveX;
            float l = ((guiGraphics.guiHeight() - j) / 2) + moveY;
            float i1 = k + i;
            float j1 = l + j;
            ...
            guiGraphics.fill(RenderType.guiOverlay(), (int) i1, (int) l, guiGraphics.guiWidth(), (int) j1, -90, -16777216);
