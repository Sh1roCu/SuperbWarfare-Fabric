...
import cn.sh1rocu.superbwarfare.util.forge.SeparateTransformsModel;
...
public class ItemRendererMixin {
    ...
    public void sw$applyTransform(ItemTransform instance, boolean leftHand, PoseStack poseStack, Operation<Void> original,
                       @Local(argsOnly = true) LocalRef<BakedModel> model, @Local(argsOnly = true) ItemDisplayContext displayContext) {
